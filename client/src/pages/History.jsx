function History() {
    return(
        <div className="whiteBackground servicePage">
            <h1 className="sectionTitle">The history of spa salons: the path to health
            care through the centuries</h1>
            <section class="whiteBackground sectionBreak prgBreak">
                <h2 className="serviceSubTitle lineBreak">Origin of Spa Treatments</h2>
                <p className="mainFont">Where does the word spa come from? Although there is no clear answer to the question of where the word spa came to be associated with healing practices, there are two main theories about the etymology of this term: "SPA" is an abbreviation of the Latin phrase "Salus per Aquam", meaning "health from water", and "SPA" is named after the Belgian village of SPA, where hot mineral springs were used by Roman soldiers to treat muscle pain and battle wounds.</p>
            </section>
            <section class="whiteBackground sectionBreak prgBreak">
                <h2 className="serviceSubTitle lineBreak">How Old Are Spa Centers?</h2>
                <p className="mainFont">Although many people associate traditional spas with Roman baths, there is evidence that spa therapy existed thousands of years ago when people believed in the healing powers of mineral waters.
            ...
            <section class="whiteBackground sectionBreak prgBreak">
                <h2 className="serviceSubTitle lineBreak">Revival of Spa Centers</h2>
                <p className="mainFont">The enthusiasm for spa treatments soon spread to the United States, where the first mass spa opened in Saratoga Springs, New York.
