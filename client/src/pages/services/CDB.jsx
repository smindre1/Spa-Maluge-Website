...
function CBD() {
    return (
      <>
        <Helmet>
          <title>CBD Custom Massage | Spa Maluge</title>
          <meta name="description" content="Ease pain, reduce inflammation, and deeply relax with our CBD Custom Massage, tailored to your body's unique needs." />
          <meta property="og:title" content="CBD Custom Massage" />
          <meta property="og:description" content="Experience personalized relief with our CBD Custom Massage. Infused with premium CBD oils to soothe muscles and calm your nervous system." />
          <meta property="og:image" content="https://spamaluge.com/og/CBD.webp" />
        ...
        <section className='prgBreak whiteBackground smallPadding'>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={"https://www.fresha.com/book-now/spa-maluge-ees8yy6h/all-offer?share=true&pId=2701511"}>Book Your Massage Here</a>
          <ul>
