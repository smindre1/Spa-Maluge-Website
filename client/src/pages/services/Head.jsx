...
function Head() {
    ...
    <>
      <Helmet>
        <title>Head, Neck & Shoulders Massage | Spa Maluge</title>
        <meta name="description" content="Ease tension, improve circulation, and relieve upper body stress with our Head, Neck & Shoulders Massage — ideal for desk workers and those with chronic neck pain." />
        <meta property="og:title" content="Head, Neck & Shoulders Massage" />
        <meta property="og:description" content="Soothe tension in the upper body with a focused massage that relaxes neck muscles, reduces headaches, and supports cervical health. Perfect for stress relief." />
        <meta property="og:image" content="https://spamaluge.com/og/head.webp" />
      ...
      <div className='servicePage'>
        ...
        <section className='prgBreak whiteBackground smallPadding'>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={import.meta.env.VITE_MASSAGE_BOOKING + "4952432&oiid=sv%3A25319291&share=true&pId=2701511"}>Book Your Massage Here</a>
          <ul>
