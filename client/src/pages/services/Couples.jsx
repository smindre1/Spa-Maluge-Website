    ...
    return (
      <>
        ...
        <section className='whiteBackground smallPadding prgBreak'>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={import.meta.env.VITE_MASSAGE_BOOKING + "4952432&oiid=sv%3A25319706&share=true&pId=2701511"}>Book Your Massage Here</a>
        </section>
        ...
        <section className='whiteBackground smallPadding prgBreak'>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={import.meta.env.VITE_MASSAGE_BOOKING + "4952432&oiid=sv%3A25319687&share=true&pId=2701511"}>Book Your Massage Here</a>
        </section>
