...
function Lymph() {
    ...
    <>
      <Helmet>
        <title>Lymphatic Drainage Massage | Spa Maluge</title>
        <meta name="description" content="Reduce swelling, eliminate toxins, and boost circulation with our Lymphatic Drainage Massage — a powerful treatment for detox and body contouring." />
        <meta property="og:title" content="Lymphatic Drainage Massage" />
        <meta property="og:description" content="Experience visible results after just one session. Our Lymphatic Drainage Massage promotes detox, reduces fluid retention, and supports full-body wellness." />
        <meta property="og:image" content="https://spamaluge.com/og/lymph.webp" />
      ...
      <div className='servicePage'>
        ...
        <section className='prgBreak whiteBackground smallPadding'>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={import.meta.env.VITE_MASSAGE_BOOKING + "4952432&oiid=sv%3A25319841&share=true&pId=2701511"}>Book Your Massage Here</a>
          <ul>
