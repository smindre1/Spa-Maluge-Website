...
function Shiatsu() {
    ...
    <>
      <Helmet>
        <title>Shiatsu Massage | Spa Maluge</title>
        <meta name="description" content="Experience the Shiatsu Massage, a traditional Japanese technique applying pressure to specific body points through loose clothing—no oils needed." />
        <meta property="og:title" content="Shiatsu Massage" />
        <meta property="og:description" content="Benefit from targeted pressure using hands and thumbs to relieve tension and restore balance in the body with a Shiatsu Massage." />
        <meta property="og:image" content="https://spamaluge.com/og/shiatsu.webp" />
      ...
      <div className='servicePage'>
        ...
        <section className='prgBreak whiteBackground smallPadding'>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={import.meta.env.VITE_MASSAGE_BOOKING + "4952432&oiid=sv%3A25320050&share=true&pId=2701511"}>Book Your Massage Here</a>
          <ul>
