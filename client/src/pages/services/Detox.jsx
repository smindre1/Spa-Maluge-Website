...
function Detox() {
    ...
    <>
      <Helmet>
        <title>Detox Custom Swedish Massage | Spa Maluge</title>
        <meta name="description" content="Unwind and detoxify with our Detox Custom Swedish Massage — a gentle, personalized treatment designed to relax muscles and flush out toxins." />
        <meta property="og:title" content="Detox Custom Swedish Massage" />
        <meta property="og:description" content="Enjoy the soothing effects of our Detox Custom Swedish Massage at Spa Maluge. Tailored to your needs, it promotes circulation, toxin release, and total relaxation." />
        <meta property="og:image" content="https://spamaluge.com/og/detox.webp" />
      ...
      <div className='servicePage'>
        ...
        <section className='prgBreak whiteBackground smallPadding'>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={import.meta.env.VITE_MASSAGE_BOOKING + "4952432&oiid=sv%3A25318558&share=true&pId=2701511"}>Book Your Massage Here</a>
          <ul>
