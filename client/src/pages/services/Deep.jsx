    ...
    return (
      <>
        ...
        <h2 className='serviceSubTitle lineBreak'>Precaution</h2>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={import.meta.env.VITE_MASSAGE_BOOKING + "4952432&oiid=sv%3A25319237&share=true&pId=2701511"}>Book Your Massage Here</a>
          <ul>
