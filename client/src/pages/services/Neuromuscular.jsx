...
function Neuromuscular() {
    ...
    <>
      <Helmet>
        <title>Neuromuscular Massage Therapy | Spa Maluge</title>
        <meta name="description" content="Relieve chronic muscle tension and restore function with Neuromuscular Massage Therapy — a focused technique that targets pain at its source." />
        <meta property="og:title" content="Neuromuscular Massage Therapy" />
        <meta property="og:description" content="This advanced therapy uses trigger point techniques and soft tissue manipulation to release muscle contractions, ease pain, and improve mobility." />
        <meta property="og:image" content="https://spamaluge.com/og/neuromuscular.webp" />
      ...
      <div className='servicePage'>
        ...
        <section className='prgBreak whiteBackground smallPadding'>
          ...
          <a className='bookNowBtn' target="_blank" rel="noopener noreferrer" href={import.meta.env.VITE_MASSAGE_BOOKING + "4952432&oiid=sv%3A25320113&share=true&pId=2701511"}>Book Your Massage Here</a>
          <ul>
