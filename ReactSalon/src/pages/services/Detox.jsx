...
function Detox() {
    ...
    <div className='servicePage'>
      <div className='flexRow prgBreak'>
        ...
        <section className='serviceSummary'>
          ...
          <ul>
            ...
            <li className='list bulletPoint serviceText'>Diseased joints become flexible and mobile.</li>
            <li className='list bulletPoint serviceText'>Puffiness disappears.</li>
            <li className='list bulletPoint serviceText'>The muscles become toned and elastic.</li>
            <li className='list bulletPoint serviceText'>Relieves fatigue and muscle spasms.</li>
            <li className='list bulletPoint serviceText'>Blood circulation and lymphatic drainage of the limb are normalized.</li>
            <li className='list bulletPoint serviceText'>There is a rapid recovery from injuries.</li>
          </ul>
        </section>
      </div>
      ...
      <section>
        ...
        <p className='serviceText lineBreak'>Classic Swedish Massage works real miracles, healing the body from many ailments.</p>
        ...
        <p className='serviceText lineBreak'>The disease gave him the impetus to develop his own exercises and massage therapy techniques, combining various techniques.</p>
      ...
      <section className='prgBreak'>
        ...
        <ul>
          <li className='serviceText bulletPoint'>30 Minutes - $70</li>
          <li className='serviceText bulletPoint'>60 Minutes - $110</li>
          <li className='serviceText bulletPoint'>90 Minutes - $160</li>
        </ul>
      </section>
